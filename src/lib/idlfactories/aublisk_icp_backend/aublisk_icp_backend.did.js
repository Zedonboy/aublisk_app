export const idlFactory = ({ IDL }) => {
  ...
  NFTData.fill(
    IDL.Record({
      'content' : IDL.Variant({
        'NftDataVec' : IDL.Vec(NFTData),
        'BlobContent' : IDL.Vec(IDL.Nat8),
      }),
      'nft_type' : IDL.Variant({
        'SERIES' : IDL.Null,
        'COLLECTION' : IDL.Null,
        'ARTICLE' : IDL.Null,
      }),
      'extension' : IDL.Variant({
        'PDF' : IDL.Null,
        'DEFAULT' : IDL.Null,
        'TEXT' : IDL.Null,
      }),
  ...
  return IDL.Service({
    'add_to_series' : IDL.Func([IDL.Text, NFTData], [Result], []),
    'approve' : IDL.Func([IDL.Principal, IDL.Text], [Result], []),
    'balanceOf' : IDL.Func([IDL.Principal], [Result], ['query']),
    'burn' : IDL.Func([IDL.Text], [Result], []),
    'check_account_id_for_ownership' : IDL.Func(
        [IDL.Text, IDL.Text],
        [IDL.Bool],
        ['query'],
      ),
    ...
    'dip721_approve' : IDL.Func([IDL.Principal, IDL.Text], [Result], []),
    'dip721_balance_of' : IDL.Func([IDL.Principal], [Result], ['query']),
    'dip721_burn' : IDL.Func([IDL.Text], [Result], []),
    ...
    'dip721_operator_of' : IDL.Func([IDL.Text], [Result_2], ['query']),
    ...
    'dip721_owner_of' : IDL.Func([IDL.Text], [Result_2], ['query']),
    ...
    'dip721_token_metadata' : IDL.Func([IDL.Text], [ManualReply_3], ['query']),
    ...
    'dip721_transfer' : IDL.Func([IDL.Principal, IDL.Text], [Result], []),
    ...
    'get_nfts' : IDL.Func([IDL.Text], [IDL.Vec(TokenMetadata)], ['query']),
    ...
    'owner_nftdata' : IDL.Func([], [IDL.Vec(NFTData)], ['query']),
    ...
    'tokenMetadata' : IDL.Func([IDL.Text], [ManualReply_3], ['query']),
    ...
    'transfer_to_account_id' : IDL.Func(
