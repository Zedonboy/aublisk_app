...
<script lang="ts">
	...
	import {identity, profile} from "$lib/store"
	import {createActor as createProfileActor} from "$lib/idlfactories/profile_canister"
	import {AuthClient} from "@dfinity/auth-client"
	import { IDENTITY_PROVIDER, PROFILE_CANISTER_ID, CANISTER_HOST } from "$lib/config";
	...
	onMount(() => {
		...
		if (await authClient.isAuthenticated()) {
			...
			let auth_identity = authClient.getIdentity()
			let profile_actor = createProfileActor(PROFILE_CANISTER_ID, {
				agent : new HttpAgent({
					host: CANISTER_HOST,
			...
			let profile_rslt = await profile_actor.get_profile()
			if(profile_rslt.Ok){
				let _profile = profile_rslt.Ok;
				profile.set(_profile)
			}
			
			identity.set(authClient.getIdentity())
			
			toasts.success("Connected Successfully")
			...
			<div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
				...
				<div class="flex items-center gap-1">
					...
					>
						...
						<ion-icon name="close-outline" class="hidden text-2xl group-aria-expanded:block"
						></ion-icon>
					</button>
					<div id="logo">
						<a href="feed.html">
				...
				<div class="max-w-[1220px] mx-auto flex items-center">
					...
					<button on:click={async e => {
						...
						authclient.login({
							...
							onSuccess() {
								let _identity = authclient.getIdentity()
								identity.set(_identity)
								toasts.success("You are connected successfully")
					...
					<button on:click={async e => {
						...
						authclient.logout()
						identity.set(null)
					}} class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:red-blue-800">
						Disconnect
					</button>
					{/if}
						...
						>
							...
							>
								...
								>
									...
									<div class="flex-1">
										<a href="timeline.html"
											><h4 class="font-medium text-sm text-black dark:text-white">Groups</h4></a
										>
								...
								>
									...
									<div class="flex-1">
										<a href="timeline.html"
											><h4 class="font-medium text-sm text-black dark:text-white">Pages</h4></a
										>
								...
								>
									...
									<div class="flex-1">
										<a href="timeline.html"
											><h4 class="font-medium text-sm text-black dark:text-white">Event</h4></a
										>
								...
								>
									...
									<div class="flex-1">
										<a href="timeline.html"
											><h4 class="font-medium text-sm text-black dark:text-white">Games</h4></a
										>
							...
							<div class="flex items-center justify-between gap-2 p-4 pb-2">
								...
								<div class="flex gap-2.5">
									...
									>
										<nav class="text-sm">
											<a href="#">
												<ion-icon class="text-xl shrink-0" name="checkmark-circle-outline"
												></ion-icon> Mark all as read</a
											>
											<a href="#">
												<ion-icon class="text-xl shrink-0" name="settings-outline"></ion-icon> Notification
												setting</a
											>
											<a href="#">
												<ion-icon class="text-xl shrink-0" name="notifications-off-outline"
												></ion-icon> Mute Notification
											</a>
										</nav>
									</div>
								</div>
							...
							<div class="text-sm h-[400px] w-full overflow-y-auto pr-2">
								...
								<div class="pl-2 p-1 text-sm font-normal dark:text-white">
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> Alexa Gray</b> started following you. Welcome him
												to your profile. 👋
											</p>
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1">Jesse Steeve</b> mentioned you in a story. Check it
												out and reply. 📣
											</p>
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> Alexa stella</b> commented on your photo “Wow, stunning
												shot!” 💬
											</p>
											<div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">8 hours ago</div>
										</div>
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> John Michael</b> who you might know, is on socialite.
											</p>
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> Sarah Gray</b> sent you a message. He wants to chat
												with you. 💖
											</p>
											<div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">4 hours ago</div>
											<div
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> Jesse Steeve</b> sarah tagged you <br /> in a photo
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> Lewis Lewis</b> mentioned you in a story. Check it
												out and reply. 📣
											</p>
											<div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">8 hours ago</div>
										</div>
									...
									>
										...
										<div class="flex-1">
											<p>
												<b class="font-bold mr-1"> Martin Gray</b> liked your photo of the Eiffel Tower.
												😍
											</p>
											<div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">8 hours ago</div>
										</div>
							...
							<nav class="p-2 text-sm text-black font-normal dark:text-white">
								...
								<button type="button" class="w-full">
									...
									>
										...
										>
											<span
												class="bg-white block h-4 relative rounded-full shadow-md w-2 w-4 dark:bg-blue-600"
											></span>
										</span>
									</div>
								</button>
		...
		>
			<div class="pr-4">
				<nav id="side">
					...
					>
						<svg
							class="bg-gray-200 rounded-full w-6 h-6 dark:bg-slate-700"
							fill="currentColor"
							viewBox="0 0 20 20"
							xmlns="http://www.w3.org/2000/svg"
							><path
